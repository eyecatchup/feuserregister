	...
	protected function _createStaticInfoTablesField() {
		if (t3lib_extMgm::isLoaded('static_info_tables')) {
			...
			switch ($this->_fieldConfiguration['staticType']) {
				case 'LANGUAGES':
					$this->_htmlField = $staticInfoObj->buildStaticInfoSelector('LANGUAGES', "tx_feuserregister[data][{$this->_fieldName}]", $this->_fieldConfiguration['CSSClassName'], array($this->_value), '', $this->_fieldConfiguration['submitFlag'], "tx-feuserregister-field-{$this->_fieldName}", $this->_fieldConfiguration['title']);
				break;
				case 'SUBDIVISIONS':
					$this->_htmlField = $staticInfoObj->buildStaticInfoSelector('SUBDIVISIONS', "tx_feuserregister[data][{$this->_fieldName}]", $this->_fieldConfiguration['CSSClassName'], array($this->_value), $this->_fieldConfiguration['countryCode'], $this->_fieldConfiguration['submitFlag'], "tx-feuserregister-field-{$this->_fieldName}", $this->_fieldConfiguration['title']);
				break;
				case 'CURRENCIES':
					$this->_htmlField = $staticInfoObj->buildStaticInfoSelector('CURRENCIES', "tx_feuserregister[data][{$this->_fieldName}]", $this->_fieldConfiguration['CSSClassName'], array($this->_value), '', $this->_fieldConfiguration['submitFlag'], "tx-feuserregister-field-{$this->_fieldName}", $this->_fieldConfiguration['title']);
				break;
				case 'COUNTRIES':
				default:
					$this->_htmlField = $staticInfoObj->buildStaticInfoSelector('COUNTRIES', "tx_feuserregister[data][{$this->_fieldName}]", $this->_fieldConfiguration['CSSClassName'], array($this->_value), '', $this->_fieldConfiguration['submitFlag'], "tx-feuserregister-field-{$this->_fieldName}", $this->_fieldConfiguration['title'], $this->_fieldConfiguration['where'], $this->_fieldConfiguration['lang'], $this->_fieldConfiguration['local']);
				break;
			}
			$value = $this->getValue(self::PARSE_HTML);
